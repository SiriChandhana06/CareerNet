      ...
      <div className='lg:grid lg:grid-cols-2 bg-blue-300 h-screen lg:h-full py-10 md:py-20 px-10'>
        <div className="flex justify-center items-center ">
          <div className="bg-white shadow-lg rounded-lg p-8 max-w-xl w-full">
            ...
            <h1 className="text-center text-2xl font-bold mt-4 mb-6">Welcome to CareerNet</h1>
            ...
            <input
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  ...
                  <span className="ml-2 text-gray-700">I agree to the CareerNet <Link href="/" className="text-blue-600 hover:underline"> Refund Policy</Link> and <Link href="/" className="text-blue-600 hover:underline">Privacy Policy</Link>.</span>
                </label>
              </div>
              <button
                type="submit"
            ...
            <div className="mt-4 flex justify-center gap-1 text-center">
              ...
              <Link href="/login">
                <h1 className="text-blue-600 hover:underline">Log in</h1>
              </Link>
            </div>
          </div>
        </div>
